...
public class FileArgumentFixture
{
    ...
    private FileArgument? _SystemUnderTest;
    ...
    private FileArgument SystemUnderTest
    {
        get
        {
    ...
    public void IsValid_Required_MustExistIsFalse_RelativePath_DirExists()
    {
        ...
        var temp = arg as FileArgument ?? throw new InvalidOperationException("Wrong type");
    ...
    public void IsValid_Required_MustExistIsFalse_RelativePath_DirDoesNotExist()
    {
        ...
        var testFile = new FileInfo(
            Path.Combine(Environment.CurrentDirectory, "bogus-dir", "garbage.txt"));
    ...
    public static FileInfo GetTestFile()
    {
        ...
        var testFilePath = Path.Combine(dirName, testFileName);
