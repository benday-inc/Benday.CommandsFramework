...
public static class CommandFrameworkConstants
{
    ...
    public const string CommandName_CheckConfig = "check-configuration";
    ...
    /// </summary>
    /// <remarks>
    /// Version 3 adds ArgumentSyntax. A consumer that builds a command line -- cmdui does --
    /// cannot guess it: a version 2 tool accepts only the slash form, and a version 3 tool
    /// may accept only the POSIX form. The absence of the property means slash.
    /// </remarks>
