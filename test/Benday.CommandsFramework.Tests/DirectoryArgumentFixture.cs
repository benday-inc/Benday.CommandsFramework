...
public class DirectoryArgumentFixture
{
    ...
    {
        // act
        _SystemUnderTest = new DirectoryArgument(EXPECTED_ARG_NAME);
    ...
    public void DataType_FromFluentApi()
    {
        ...
        // act
        _SystemUnderTest = arg as DirectoryArgument ?? throw new InvalidOperationException("Wrong type");
    ...
    public void DataType_AsSeenThroughIArgument()
    {
        ...
        IArgument arg = new DirectoryArgument(EXPECTED_ARG_NAME);
    ...
    {
        // arrange -- DirectoryArgument reports the same DataType as a plain string argument, which
        // is why DataType alone cannot tell a directory argument apart from a string one.
        // The distinction travels on IArgument.PathType instead.
        IArgument fileOrDirectory = new DirectoryArgument(EXPECTED_ARG_NAME);
